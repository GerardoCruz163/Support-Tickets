...
<title>Mantenimiento a prioridades :. TLA SuTra</title>
<body class="with-side-menu">
		...
		<div class="container-fluid">
			<header class="section-header">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<h3>Mantenimiento a prioridades
							</h3>
							<ol class="breadcrumb breadcrumb-simple">
								<li><a href="#">Inicio</a></li>
								
								<li class="active">
                                    Mantenimiento a prioridades
								</li>
							</ol>
						</div>
					</div>
	...
	<script type="text/javascript" src="mtnprioridad.js"></script>
